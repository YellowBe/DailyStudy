...
class SweeperDataSet(data.Dataset):
...
class SweeperValDataSet(data.Dataset):
...
class SweeperTestDataSet(data.Dataset):

    def __init__(self, root='', list_path='',
                 mean=(128, 128, 128), ignore_label=0):
        self.root = root
        self.list_path = list_path
        self.ignore_label = ignore_label
        self.mean = mean
